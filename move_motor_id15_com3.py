#!/usr/bin/env python3
"""
Move Robstride Motor ID 15 on COM3
...
def move_motor_id15():
    """Connect to COM3 and move motor ID 15."""
    print("=" * 60)
    print("   ROBSTRIDE MOTOR ID 15 - COM3")
    print("=" * 60 + "\n")
    
    port = 'COM3'
    motor_id = 0x0F  # Motor ID 15
    sdo_cob = 0x600 + motor_id  # 0x60F for SDO commands
    ...
    try:
        ...
        # CRITICAL: Set motor to POSITION MODE
        print("[2] Setting motor to POSITION MODE...")
        print("    (This is required for position commands to work)")
...
if __name__ == "__main__":
    print("\nRobstride Motor Controller - ID 15 on COM3\n")
    
    success = move_motor_id15()
    ...
    if not success:
        ...
        print("  4. Check motor CAN ID is actually 15")
