...
private:
    ...
    std::unordered_map<uint64_t, Edge>* edges; // Using uint64_t for compatibility
...
public:
    ...
    void set_graph_references(std::unordered_map<uint64_t, Node>* node_map,
                             std::unordered_map<uint64_t, Edge>* edge_map);
